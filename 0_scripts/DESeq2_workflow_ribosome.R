...
polysome_control = colMeans(mod_mat[dds$type == "ribosome" & dds$condition == "control", ])
polysome_treatment = colMeans(mod_mat[dds$type == "ribosome" & dds$condition == "treatment", ])
